...
[assurance]
# One of 'cappuchino', 'espresso' or '*'
profile = *

# One of 'unique' or '*'
uid_uniqueness = unique
# One of 'no-reassign', 'reassign-1y' or '*'
eppn_uniqueness = no-reassign

# One of '*', 'low', 'medium' or 'high'
identity_assurance = low
# One of 'True' or 'False'
identity_qualifies_for_local_enterprise = True

# One of '1m', '1d' or '*'
attribute_freshness = 1d
...
login_host = <Hostname of the HDF-portal>
...
# Primary group the user should be added to. E.g. Nico's group for testing HDF-LSDF:
primary_group_id = 1009662
# or Marcus' test group:
#primary_group_id = 1002637
...
http_user = hdfrest
http_pass = jRjn32jfmsDjfEJ
#http_user = hdfrest2
#http_pass = fR5jD3kKwmdE
